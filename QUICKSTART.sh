...
echo "  sudo python agent/saas_enforcer.py --mode local --iface <your-iface>"
echo "    # e.g. sudo python agent/saas_enforcer.py --mode local --iface enp0s3"
echo ""
echo -e "${YELLOW}Gateway Mode (protect victim VM):${NC}"
echo "  sudo python agent/saas_enforcer.py --mode gateway --target-ip 192.168.1.10 --iface <your-iface>"
echo "    # Use --iface to bind iptables/NFQUEUE to the external interface (recommended)"
echo "    # List interfaces: ip -o link show | awk -F': ' '{print \$2}'"
echo ""
